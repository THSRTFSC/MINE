package com.mine.framework.image;
...
public class ImageLoader {
    ...
    // TODO
    private static final int TAG_KEY_URI = R.id.ifRoom;
    ...
    public static final Executor THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(
            CORE_POOL_SIZE, MAXIMUN_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), sThreadFactory);
    ...
    public void buildBitmap(final String uri, final ImageView imageView) {
        buildBitmap(uri, imageView, 0, 0);
    }

    public void buildBitmap(final String uri, final ImageView imageView, final int reqWidth, final int reqHeight) {
